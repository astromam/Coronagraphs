...
#        b1  = np.zeros((self.corono.nlam*self.ndz*2))
#        
##        b0bis  = np.zeros((self.corono.nlam*self.ndzdirect*2))
##        b1bis  = np.zeros((self.corono.nlam*self.ndzdirect*2))
#        
...
#MaxContrast ProblemMatrix subclass
#"""
#class MaxContrastDirect(ProblemMatrix):
#    r"""
#    Defines the ProblemMatrix subclass for the optimization problem that 
#    maximizes the contrast in a given search area for a given integrated 
#    apodizer transmission :math:`\tau`. Addition of constraints on the EE transmission
#    """
#    default_params = get_default_params_MaxContrastDirectProblemMatrix()
#    
#    def __init__(self, **kwargs):
#        """
#        Constructor for the Matrix problem with 
#        the coronagraph object.
#        """
#        super(MaxContrastDirect,self).__init__(**kwargs)
#
#        self.neps = self.ndz
#
##%%    
...
#            *self.corono.Pupil1d[self.idx_pup]/(2.*self.corono.nPup)**2/self.TR, 
#                                  Z0))
##        A6  = 2.*np.pi*np.array(self.idx_dzdirect)*(self.corono.Fmax\
##                              /self.corono.nImg)**2
#        
#        b0  = np.zeros((self.corono.nlam*self.ndz*2))
#        b1  = np.zeros((self.corono.nlam*self.ndz*2))
