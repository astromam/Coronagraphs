...
#%%
def sft_half_ax0(A2, NB, m, inv=False, CtrBtwnPix=False):
    """
    Slow Fourier Transform, using the theory described in [1]_. 
    Assumes the original array is square. 
...
#%%
def isft_half_ax0(A2, NB, m, CtrBtwnPix=False):
    """
    Explicit inverse Slow Fourier Transform, using the theory described in [1].
    ...
    """
    return sft_half_ax0(A2, NB, m, inv=True, CtrBtwnPix=CtrBtwnPix)


#%%
def sft_half_ax1(A2, NB, m, inv=False, CtrBtwnPix=False):
    """
    Slow Fourier Transform, using the theory described in [1]_. 
    Assumes the original array is square. 
...
#%%
def isft_half_ax1(A2, NB, m, CtrBtwnPix=False):
    """
    Explicit inverse Slow Fourier Transform, using the theory described in [1].
    ...
    """
    return sft_half_ax1(A2, NB, m, inv=True, CtrBtwnPix=CtrBtwnPix)
