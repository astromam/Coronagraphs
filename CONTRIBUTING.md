Contributing to Coronagraphs
===================


First off, thank you for considering contributing to Coronagraphs. 

How to contribute
-----------------

The preferred workflow for contributing to Coronagraphs is to fork the
[main repository](https://github.com/astromam/Coronagraphs) on
GitHub, clone, and develop on a branch. Steps:

1. Fork the [project repository](https://github.com/astromam/Coronagraphs)
...
and then ``git commit`` files:
   ...
   to record your changes in Git, then push the changes to your GitHub account 
   with:
...
-  If your pull request addresses an issue, please use the pull request title
   to describe the issue and mention the issue number in the pull request 
