...
#%%
res_dirs=("d:/Andes/Data_corono/results/20240723135922",
          "d:/Andes/Data_corono/results/20240723140407",
          "d:/Andes/Data_corono/results/20240723141506")
...
# masked
    ...
    while True:
        ...
        plt.title(('lyot stop diam. : ' + str(np.round(dL[i_min[0]],2))))
        plt.colorbar()
        fnm = "/obsVsFPM_t"+str(int(np.round(1000*thr)))+"m."
        ...
        plt.title(('obstruction : ' + str(np.round(obs[i_min[1]],2))))
        plt.colorbar()
        fnm = "/DLyotVsFPM_t"+str(int(np.round(1000*thr)))+"m."
        plt.savefig(save_dir+fnm+"pdf")
        plt.savefig(save_dir+fnm+"svg")
        plt.show()
        ...
        plt.title(('FPM [lam/D] : ' + str(np.round(mB[i_min[2]],2))))
        plt.colorbar()
        fnm = "/DLyotVsObs_t"+str(int(np.round(1000*thr)))+"m."
        plt.savefig(save_dir+fnm+"pdf")
        plt.savefig(save_dir+fnm+"svg")
        plt.show()
        ...
        plt.xlabel("obstruction")
        plt.ylabel("Lyot stop diam.")
        fnm = "/throughput_DLyoVsobs_t"+str(int(np.round(1000*thr)))+"m."
        plt.savefig(save_dir+fnm+"pdf")
        plt.savefig(save_dir+fnm+"svg")
        plt.show()
