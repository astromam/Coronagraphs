...
if True:
    ...
    rMask1  = 3.0 #2.64#2.64#rMask_m/(wv1*Fratio)  # mask size in lam1/D
    # mask radius in lam0/D units
    rMask_m = rMask1*1.6e-6*Fratio # 453e-6/2
...
wv1 = 1.6e-6 #rMask_m/(rMask1*Fratio)
if pupil_name == 'tmt':
    wv1 = wv0*1 #rMask_m/(rMask*Fratio)
    rMask1 = rMask*1.
elif pupil_name == 'elt':
    wv1 = wv0*1 #rMask_m/(rMask*Fratio)
    rMask1 = rMask*1.
