...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec  2 21:01:31 2024
...
#    if kwd_qrt:
    ...
    if LSRobustness:
        ...
        PsiD_LSshift_re = np.empty_like(PsiD_im) 
        PsiD_LSshift_im = np.empty_like(PsiD_re) 
    ...
    if LSRobustness:
        print(f'dimensions PsiD_LSshift_re: {np.shape(PsiD_LSshift_re)}')
        print(f'dimensions PsiD_LSshift_im: {np.shape(PsiD_LSshift_im)}')
    if ImPart:
