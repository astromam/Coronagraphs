...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 23 09:53:25 2022
...
"""
# spectral band
band = 'ES_H' # 'BB_J', 'BB_H', 'H2' filters
...
pixel  = 12.5 # ERIS+SPIFFIER pixel sampling [mas/pix]
...
fname_SAXOmapnm3dless = f'2018-04-04T00-41-34-saxo_residual_turbulence_time30.0sec_seeing{seeing:.1f}as_tiptilt1_gains0_fitting1_alias1_nPup{nPup:04d}_k{int(np.round(saxoplus_factor*100)):03d}.fits'
...
fpath_SAXOmapnm3d     = fdir_dat / fname_SAXOmapnm3dless
...
params = coro.to_dict(nPup=nPup, nImg2d=nImg2d, Fmax2d = nFre2d, nFPM = nFPM,
                 ...
                 Pupil2d = Pupil2d, LyotStop2d = Pupil2d, 
...
fname_direct_cube = 'dir' + str_common + '_img_f' + str_offaxis + str_sphplus + str_noi + '_ES.fits'
...
OPDmap2d0 = saxoplus_factor*(beta_wfs*ZELDAmapnm3d)*1e-9


for imap in range(nmap):
    t0 = time.time()
    OPDmap2d = OPDmap2d0 + SAXOmapnm3d[imap]*1e-9
    direct_mono_img_f += corono0.compute_direct_intensity_2d_bis(Pupil2d, OPDmap2d=OPDmap2d, poly=False)
...
if kwd_pla:
    ...
    for imap in range(nmap):
        ...
        direct_mono_img_fp += corono0.compute_direct_intensity_2d_bis(Pupil2d, OPDmap2d=OPDmap2d, poly=False)
