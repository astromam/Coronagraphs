...
def tpool_init(OPDmap2d0_i, SAXOmapnm3d_i, corono0_i,
               direct_mono_img_cube_i, direct_mono_img_cube_shape_i):
    '''
    Thread pool initialization
    '''
    global OPDmap2d0, SAXOmapnm3d, corono0, direct_mono_img_cube, direct_mono_img_cube_shape
...
#%%    
    ...
    # compute spatial frequencies in the final image plane
    pixel  = 12.5  # IRDIS pixel sampling [mas/pix]
...
#    fdir = Path('~/data/ZELDA/CoroSimulations/').expanduser()
    ...
    fname_SAXOmapnm3d     = f'2018-04-04T00-41-34-saxo_residual_turbulence_time30.0sec_seeing{seeing:.1f}as_tiptilt1_gains0_fitting1_alias1_nPup{nPup:04d}_k{int(np.round(saxoplus_factor*100)):03d}.fits'
