...
fdir_newapod = Path('/Users/mndiaye/Library/CloudStorage/OneDrive-UniversitéNiceSophiaAntipolis/data/Coronagraphs/results/2D/dat_pyth/vlt_btw').resolve()

#%%
"""
### Apodizer file
"""
fname_newapod = 'vlt_btw_APLC_obs=0.14_lsid=0.28_lsod=1.00_IWA=0.0_OWA=20.0_BW=0.20_nlam=03_1D_N=0512_nFPM=50.000000_rMask=2.252MaxContrastL1_tau=0.756_gurobipy_deadact.fits'
...
fname_apod2d_ini = 'newapod_initial'
fname_apod2d_bin = 'newapod_binary'
...
"""
apod2d_bin_tmp = floyd_steinberg(normscaledapod)
