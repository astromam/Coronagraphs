...
Adapated for use with HiCAT pupil by Kathryn St.Laurent Thurs Oct 11 2018
...
if pupil_name == 'lvr':
	...
	fname_lys = 'HiCAT-Lyot_F-N0{0}_LS-Ann-bw-ID0345-OD0807-SpX0036'.format(nPup,)
else:
...
Apodizer import
"""
fdir = 'apodizers/HiCAT/'
#apod = 'Test_C_telserv3_HiCAT_' + problem1.get_filename()
apod = 'Test_S_telserv3_HiCAT_' + problem1.get_filename() + '_gurobipy_sparseA'
...
for k in [0]:
	#Aperture
	fname = fname_pup + '.pdf'
	fpath = fdir_pdf + 'input_plots/'+ fname 
	pl.figure(1)
	pl.clf()
