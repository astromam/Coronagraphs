...
pl.plot(corono0.r, Apod2, label='MaxContrast,   L1-norm')
pl.plot(corono0.r, Apod3, label='MaxContrast, Linf-norm')
...
pl.semilogy(corono0.xi,poly_corono_image2/poly_direct_image2.max(),label='MaxContrast, L1-norm')
#pl.semilogy(corono0.xi,poly_direct_image3/poly_direct_image3.max(),label='Direct')
pl.semilogy(corono0.xi,poly_corono_image3/poly_direct_image3.max(),label='MaxContrast, Linf-norm')
